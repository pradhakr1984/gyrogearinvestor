...
function Hb(a,b,c){Z||(Z={},Lb=new Set,Nb.addEventListener("message",function(d){a:if(Lb.has(d.origin)){try{var f=JSON.parse(d.data)}catch(g){break a}var e=Z[f.id];if(e&&d.origin===e.O)switch(d=e.U,d.m=!0,d.m&&(va(d.l,d.sendMessage,d),d.l.length=0),e=f.event,f=f.info,e){case "apiInfoDelivery":if(H(f))for(var h in f)f.hasOwnProperty(h)&&(d.v[h]=f[h]);break;case "infoDelivery":Jb(d,f);break;case "initialDelivery":H(f)&&(clearInterval(d.h),d.playerInfo={},d.v={},Kb(d,f.apiInterface),Jb(d,f));break;case "alreadyInitialized":clearInterval(d.h);
break;default:d.j.i||(h={target:d,data:f},d.j.G(e,h),wb("player."+e,h))}}}));
